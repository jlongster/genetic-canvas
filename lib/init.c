...
#define ___GLO_COUNT 24
#define ___SUP_COUNT 9
#define ___SUB_COUNT 7
#define ___LBL_COUNT 85
#include "gambit.h"
...
___DEF_GLO(13,"cons")
___DEF_GLO(14,"eq?")
___DEF_GLO(15,"init-engine")
___DEF_GLO(16,"init-opengl")
___DEF_GLO(17,"load")
___DEF_GLO(18,"null?")
___DEF_GLO(19,"run-frame")
___DEF_GLO(20,"string-append")
___DEF_GLO(21,"string-length")
___DEF_GLO(22,"string-ref")
___DEF_GLO(23,"substring")
___END_GLO
...
___DEF_SUB_STR(___X6,45)
               ...
               ___STR8(112,104,105,99,115,45,103,97)
               ___STR5(109,98,105,116,47)
...
___DEF_SLBL(2,___L2__20_init)
   ___SET_R0(___LBL(3))
   ___JUMPGLOSAFE(___SET_NARGS(1),17,___G_load)
___DEF_SLBL(3,___L3__20_init)
   ...
   ___SET_GLO(8,___G_run_2d_frame_2d_c,___PRC(83))
   ___SET_R1(___VOID)
   ___POLL(4)
...
___DEF_SLBL(1,___L1_path_2d_trim)
   ___IF(___NOT(___EQP(___GLO(22,___G_string_2d_ref),___PRM(22,___G_string_2d_ref))))
   ...
   ___IF(___EQP(___GLO(14,___G_eq_3f_),___PRM(14,___G_eq_3f_)))
...
___DEF_SLBL(2,___L2_path_2d_trim)
   ...
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___IF(___NOT(___EQP(___GLO(14,___G_eq_3f_),___PRM(14,___G_eq_3f_))))
   ___GOTO(___L51_path_2d_trim)
   ___END_IF
...
___DEF_GLBL(___L26_path_2d_trim)
   ...
   ___ADJFP(2)
   ___IF(___NOT(___EQP(___GLO(21,___G_string_2d_length),___PRM(21,___G_string_2d_length))))
...
___DEF_GLBL(___L28_path_2d_trim)
   ___JUMPGLOSAFE(___SET_NARGS(3),23,___G_substring)
...
___DEF_GLBL(___L29_path_2d_trim)
   ...
   ___IF(___NOT(___EQP(___GLO(9,___G__2d_),___PRM(9,___G__2d_))))
...
___DEF_SLBL(6,___L6_path_2d_trim)
   ___JUMPGLOSAFE(___SET_NARGS(2),9,___G__2d_)
___DEF_SLBL(7,___L7_path_2d_trim)
   ...
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___IF(___EQP(___GLO(22,___G_string_2d_ref),___PRM(22,___G_string_2d_ref)))
...
___DEF_GLBL(___L43_path_2d_trim)
   ___JUMPGLOSAFE(___SET_NARGS(1),21,___G_string_2d_length)
___DEF_SLBL(16,___L16_path_2d_trim)
   ___ADJFP(-2)
   ___GOTO(___L27_path_2d_trim)
___DEF_SLBL(17,___L17_path_2d_trim)
   ___ADJFP(-2)
   ___IF(___EQP(___GLO(9,___G__2d_),___PRM(9,___G__2d_)))
...
___DEF_GLBL(___L45_path_2d_trim)
   ___JUMPGLOSAFE(___SET_NARGS(2),14,___G_eq_3f_)
...
___DEF_GLBL(___L48_path_2d_trim)
   ___JUMPGLOSAFE(___SET_NARGS(2),22,___G_string_2d_ref)
...
___DEF_GLBL(___L_join_2d_paths)
   ___IF(___NOT(___EQP(___GLO(11,___G_car),___PRM(11,___G_car))))
...
___DEF_GLBL(___L40_join_2d_paths)
   ...
   ___IF(___NOT(___EQP(___GLO(12,___G_cdr),___PRM(12,___G_cdr))))
...
___DEF_SLBL(3,___L3_join_2d_paths)
   ...
   ___SET_R0(___LBL(4))
   ___ADJFP(-4)
   ___JUMPGLOSAFE(___SET_NARGS(3),20,___G_string_2d_append)
___DEF_SLBL(4,___L4_join_2d_paths)
   ___IF(___NOT(___EQP(___GLO(18,___G_null_3f_),___PRM(18,___G_null_3f_))))
   ___GOTO(___L82_join_2d_paths)
   ___END_IF
   ___IF(___NOT(___NULLP(___STK(-2))))
   ___GOTO(___L76_join_2d_paths)
   ___END_IF
   ___IF(___EQP(___GLO(21,___G_string_2d_length),___PRM(21,___G_string_2d_length)))
...
___DEF_GLBL(___L62_join_2d_paths)
   ___SET_R1(___STK(-4))
   ___ADJFP(-4)
   ___IF(___EQP(___GLO(11,___G_car),___PRM(11,___G_car)))
...
___DEF_GLBL(___L67_join_2d_paths)
   ...
   ___SET_R0(___LBL(20))
   ___ADJFP(4)
   ___JUMPGLOSAFE(___SET_NARGS(1),12,___G_cdr)
...
___DEF_GLBL(___L68_join_2d_paths)
   ...
   ___SET_R1(___STK(-1))
   ___SET_R0(___LBL(21))
   ___JUMPGLOSAFE(___SET_NARGS(1),11,___G_car)
...
___DEF_GLBL(___L69_join_2d_paths)
   ...
   ___SET_R0(___LBL(13))
   ___ADJFP(4)
   ___JUMPGLOSAFE(___SET_NARGS(1),18,___G_null_3f_)
...
___DEF_SLBL(28,___L28_join_2d_paths)
   ...
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___IF(___EQP(___GLO(12,___G_cdr),___PRM(12,___G_cdr)))
...
___DEF_GLBL(___L_resource)
   ___IF(___NOT(___EQP(___GLO(13,___G_cons),___PRM(13,___G_cons))))
...
___DEF_SLBL(3,___L3_resource)
   ___JUMPGLOSAFE(___SET_NARGS(2),10,___G_apply)
...
___DEF_SLBL(4,___L4_resource)
   ___JUMPGLOSAFE(___SET_NARGS(2),13,___G_cons)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1_init_2d_opengl_2d_c)
   ___JUMPGLOSAFE(___SET_NARGS(2),16,___G_init_2d_opengl)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1_init_2d_engine_2d_c)
   ___JUMPGLOSAFE(___SET_NARGS(0),15,___G_init_2d_engine)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1_run_2d_frame_2d_c)
   ___JUMPGLOSAFE(___SET_NARGS(0),19,___G_run_2d_frame)
___END_P_SW
___END_P_COD
